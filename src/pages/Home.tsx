...
// Animated squiggle SVG background element
  ...
  return (
    <div>
      ...
      <section ref={heroRef} style={{ minHeight: '100vh', position: 'relative', overflow: 'hidden', display: 'flex', alignItems: 'center', padding: '100px 52px 80px' }}>
        ...
        {/* Background logo — bottom right, parallax */}
        <motion.img
  src="/logo.webp"
  alt=""
  style={{
...
/>
        ...
        {/* Squiggle — top area */}
        <Squiggle
          color={dark ? 'rgba(26,86,240,0.1)' : 'rgba(26,86,240,0.08)'}
          style={{ top: 80, left: 0, width: '100%', height: 120, zIndex: 0 }}
        />
      ...
      <section style={{ padding: '96px 52px', position: 'relative', overflow: 'hidden' }}>
        {/* Background logo — top right of this section */}
        ...
        <Squiggle
          color={dark ? 'rgba(26,86,240,0.08)' : 'rgba(26,86,240,0.06)'}
          style={{ bottom: 20, left: 0, width: '100%', height: 120, zIndex: 0, transform: 'scaleY(-1)' }}
        />
      ...
      <section style={{ background: C.blue, padding: '80px 52px', position: 'relative', overflow: 'hidden' }}>
        ...
        <Squiggle
          ...
          style={{ bottom: 0, left: 0, width: '100%', height: 100, zIndex: 0 }}
        />
      ...
      <section style={{ padding: '96px 52px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <Squiggle
          color={dark ? 'rgba(26,86,240,0.09)' : 'rgba(26,86,240,0.06)'}
          style={{ top: 0, left: 0, width: '100%', height: 120, zIndex: 0 }}
        />
        <div style={{ position: 'relative', zIndex: 1 }}>
