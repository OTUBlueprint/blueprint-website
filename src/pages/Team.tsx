    ...
    <div style={{ padding: '100px 52px 80px' }}>
      ...
      <div style={{ marginTop: 72 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 60, alignItems: 'start', paddingTop: 36 }}>
          ...
          <Reveal delay={80}>
            <div>
              {['Social Media Director', 'Frontend Developer', 'Backend Developer', 'UI/UX Designer', 'Community Director', 'VP Internal', 'VP External', 'Content Creator'].map(role => (
                <motion.div key={role} whileHover={{ x: 5 }}
                  ...
                  <span style={{ fontFamily: F.mono, fontSize: '0.6rem', letterSpacing: '0.1em', textTransform: 'uppercase', color: C.blue }}>Opening Soon →</span>
                </motion.div>
              ))}
            </div>
          </Reveal>
